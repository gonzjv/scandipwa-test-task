...
import { CheckouProcessBar } from 'Component/CheckoutProcessBar/CheckoutProcessBar.component.js';
...
export class Checkout extends PureComponent {
  ...
  updateHeader() {
    ...
    setHeaderState({
      name:
        checkoutStep === DETAILS_STEP ? CHECKOUT_SUCCESS : CHECKOUT,
      title,
      onBackClick: () => goBack(),
    });
  }
